...
// data here
const anjuran = `
عن أبي هريرة رضي الله عنه : أنَّ رَسولَ اللَّهِ صَلَّى اللهُ عليه وسلَّمَ قالَ: إنَّ لِلَّهِ تِسْعَةً وتِسْعِينَ اسْمًا مِئَةً إلَّا واحِدًا، مَن أحْصَاهَا دَخَلَ الجَنَّةَ"
قال تعالَى: {وَلِلَّهِ الْأَسْمَاءُ الْحُسْنَى فَادْعُوهُ بِهَا وَذَرُوا الَّذِينَ يُلْحِدُونَ فِي أَسْمَائِهِ} [الأعراف: 180]، وقدْ علَّمَها لنا النَّبيُّ صلَّى اللهُ عليه وسلَّمَ، وحَرَصَ على إيضاحِها. وفي هذا الحديثِ يُخبِرُ النَّبيُّ صلَّى اللهُ عليه وسلَّمَ أنَّ للهِ تعالَى تِسْعَةً وتِسعينَ اسمًا، وأنَّ مَن أحْصاها فحَفِظها في صَدْرِه وعَرَفَهَا، دخَل الجنَّةَ؛ جَزاءً على هذا الحفْظِ والإحصاءِ. أو المرادُ بإحصَائِها وحفْظِها: الإحاطَةُ بها لَفظًا ومعنًى، أو دُعاءُ اللهِ بها؛ لقولِه تعالَى: { {فَادْعُوهُ بِهَا} }؛ وذلك بأنْ تَجعلَها وَسِيلةً لكَ عندَ الدُّعاءِ، فتَقولَ: يا ذا الجلالِ والإكرامِ، يا حَيُّ يا قَيُّومُ، وما أشبَهَ ذلك، وقِيل: أنْ تَتعبَّدَ للهِ بِمُقتضاها، فإذا عَلِمْتَ أنَّه رَحِيمٌ تَتعرَّضُ لرَحمتِه، وإذا عَلِمتَ أنَّه غَفورٌ تَتعرَّضُ لمَغفرتِه، وإذا عَلِمتَ أنَّه سَمِيعٌ اتَّقَيْتَ القولَ الَّذِي يُغضِبُه، وإذا عَلِمتَ أنَّه بَصيرٌ اجتَنَبْتَ الفِعلَ الَّذي لا يَرضاهُ ".`
...
handler.tags = ['quran']
handler.command = /^(عبارات)$/i
export default handler

global.asmaulhusna = [
    {
        index: 1,
        latin: "💐 *المؤلف:* *جون ماكسويل*",
        arabic: "💐 *الاقتباس:في الحياة ، تكسب أحيانًا ، وفي أحيان أخرى تتعلم*",
        translation_id: "💐 *الرأي: *عليك أن تتعلم من تلك اللحظات غير السارة ، لكي تستمر في النمو كأفراد. بمعنى آخر ، لا يهم كيف تسقط ، ولكن كيف تنهض*",
        translation_en: "بمعنى آخر ، لا يهم كيف تسقط ، ولكن كيف تنهض."
    },
    {
        index: 2,
        latin: "💐 *الكاتب:* *باولو كويلو*",
        arabic: "💐 *الاقتباس:*لا تقيس ثروتك بالمال الذي لديك ، قم بقياس ثروتك بالأشياء التي لديك والتي لا يمكنك استبدالها بالمال",
        translation_id: "💐 *الراي:* في المجتمع المادي من السهل تقييم الذات بناء على ممتلكاتنا ، وهذا النوع من التقييم سلبي جدا لتقدير الذات",
        translation_en: "أيضًا ، ما يجعلك سعيدًا حقًا على أساس يومي هي تلك الأشياء الصغيرة وتلك اللحظات الممتعة"
    },
    {
        index: 3,
        latin: "💐 *Autor:* *Anónimo*",
