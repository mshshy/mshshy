...
conn.welcome = '✦━━━━[ 𝚑𝚎𝚗𝚛𝚢 ]━━━━✦\n\n┏––––––━━━━━━━━•\n│⫹⫺ @subject\n┣━━━━━━━━┅┅┅\n│( نورت الروم ✨♥@user)\n├[ *المطور* ]—\n│ *MO SHOKR*\n┗––––––━━┅┅┅\n\n––––––┅┅ *الوصف ✨♥*┅┅––––––\n@desc' 
   conn.bye = '✦━━━━[ EL FARA3NA BOT  ]━━━━✦\n *هتغور هيجي مكانك طبور 🌚❤️️* @user* 👋🏻*'
conn.spromote = '*@user مبروك الادمن ✨❤️*'
conn.sdemote = '*@user كنت ادمن حلو  ✨❤️*'
conn.sDesc = '*تم تعديل وصف الجروب ✨❤️*\n\n*الوصف الجديد:* @desc'
conn.sSubject = ' تم تغير اسم الجروب ✨❤️*\n*الاسم الجديد:* @subject'
conn.sIcon = '*تم تغير صوره الجروب ✨❤️*'
...
setInterval(async () => {
  ...
  const bio = `EL FARA3NA BOT [ ⏳ ] Uptime: ${uptime}`;
